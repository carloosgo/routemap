const ISO_A2_TO_A3 = Object.freeze({
  ...
  VN: 'VNM', VU: 'VUT', WF: 'WLF', WS: 'WSM', XK: 'XKO', YE: 'YEM', YT: 'MYT', ZA: 'ZAF',
  ZM: 'ZMB', ZW: 'ZWE',
});

export function iso2ToIso3(value) {
  const code = String(value || '').trim().toUpperCase();
  return ISO_A2_TO_A3[code] || '';
}

export function isSupportedIso2(value) {
  return Boolean(iso2ToIso3(value));
}

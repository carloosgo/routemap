...
const script = join(here, 'storage-v4-phase-k-observability-apply-dev.ps1');
...
if (!powershell) {
  console.error('No se encontró PowerShell ejecutable para el apply de observabilidad de Phase K.');
  process.exit(1);
}

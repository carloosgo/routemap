...
const script = join(here, 'storage-v4-phase-k-budget-diagnose.ps1');
...
if (!powershell) {
  console.error('No se encontró PowerShell ejecutable para el diagnóstico de budget de Phase K.');
  process.exit(1);
}

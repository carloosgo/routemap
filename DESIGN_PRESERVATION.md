...
- La superficie principal del header queda plana, con `box-shadow: none`, pero usa `border-bottom: 1px solid #eef0f2` como separación gris muy tenue respecto al workspace inferior; la profundidad con el mapa se expresa únicamente desde el panel integrado izquierdo.

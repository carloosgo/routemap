...
- La lista de destinos del panel integrado se proyecta como una cuadrícula de tres cards por fila en escritorio, reutilizando cada `SegmentForm` existente; no se crea un segundo modelo de itinerario ni una colección paralela.

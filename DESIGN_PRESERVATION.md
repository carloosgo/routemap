...
- La superficie principal del header queda plana, con `box-shadow: none`; la separación de profundidad con el mapa se expresa únicamente desde el panel integrado izquierdo.

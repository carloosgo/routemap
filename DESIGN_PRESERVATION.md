...
- Alineación responsive del itinerario: en escritorio la columna de ciudad absorbe el ancho disponible, mientras fechas, noches, costo y acciones conservan su geometría compacta. La última acción de cada trayecto y el botón `Guardar` comparten la misma guía derecha, evitando espacio blanco sobrante en pantallas amplias.

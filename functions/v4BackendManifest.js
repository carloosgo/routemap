export const V4_EVENTARC_REGION = 'northamerica-south1';
export const V4_SERVICE_REGION = 'us-central1';
export const V4_BACKEND_REGION = V4_SERVICE_REGION;
export const V4_EVENTARC_DESTINATION_FUNCTION = 'v4FirestoreEventIngress';

export const V4_BACKEND_FUNCTION_NAMES = Object.freeze([
  V4_EVENTARC_DESTINATION_FUNCTION,
  'v4TripLifecycle',
  'v4TripPurge',
]);

export const V4_BACKEND_FUNCTION_REGIONS = Object.freeze({
  [V4_EVENTARC_DESTINATION_FUNCTION]: V4_SERVICE_REGION,
  v4TripLifecycle: V4_SERVICE_REGION,
  v4TripPurge: V4_SERVICE_REGION,
});

export const V4_EVENTARC_TRIGGERS = Object.freeze([
  Object.freeze({

...
const script = join(here, 'storage-v4-phase-k-sync-unexpected-errors-diagnose-dev.ps1');
...
if (!powershell) {
  console.error('No se encontro PowerShell ejecutable para el diagnostico sync de Phase K.');
  process.exit(1);
}

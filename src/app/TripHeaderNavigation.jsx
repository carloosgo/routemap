...
const NAV_ITEMS = [
  { id: 'segments', labelKey: 'itinerary', Icon: IconListDetails, color: '#357d94' },
  { id: 'places', labelKey: 'myRoutes', Icon: IconRoute, color: '#7c5ce7' },
  { id: 'notes', labelKey: 'notes', Icon: IconNotebook, color: '#e08a17' },
];
    ...
    >
      {NAV_ITEMS.map(({ id, labelKey, Icon, color }) => {
        ...
        return (
          ...
          >
            <span className="trip-summary__primary-nav-icon" style={{ color }} aria-hidden="true">

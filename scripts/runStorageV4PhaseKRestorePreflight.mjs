...
const script = join(here, 'storage-v4-phase-k-restore-preflight.ps1');
...
if (!powershell) {
  console.error('No se encontró PowerShell ejecutable para el preflight de restore de Phase K.');
  process.exit(1);
}
